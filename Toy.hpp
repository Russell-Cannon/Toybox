...
class Toy {
  public:
    ...
    void AddChild(Toy* toy) { children.push_back(toy); }
};
...
class LitError : public Toy {
  public:
    ...
    std::string GenerateGLSL() { return "vec3(1.0, 0, 1.0)"; }
};
...
class LitNumber : public Toy {
    ...
    std::string GenerateGLSL() { return "vec3(" + std::to_string(Value) + ")"; }
...
class SawTooth : public Unary {
    ...
    std::string GenerateGLSL() {
        Unary::GenerateGLSL();
        return "(1.0 - abs(fract(" + children[0]->GenerateGLSL() +
               "*0.5)*2.0-1.0))";
    }
};
...
class Texture : public Unary {
    ...
    std::string GenerateGLSL() {
        ...
        return "texture(u_texture, vec2(" + childOutput + ".x, -" +
               childOutput + ".y)).xyz";
    }
};
...
class Screen : public Unary {
    ...
    std::string GenerateGLSL() {
        Unary::GenerateGLSL();
        std::string st = "abs(mix(vec2(-1.0), vec2(1.0), " +
                         children[0]->GenerateGLSL() + ".xy))";
...
class Noise : public Unary {
    ...
    std::string GenerateGLSL() {
        Unary::GenerateGLSL();
        std::string seed = children[0]->GenerateGLSL();
        return "vec3((snoise(" + seed + ".xy + vec2(" + seed +
               ".z)) + 1.0 ) / 2.0)";
    }
};
...
class Modulus : public Binary {
    ...
    std::string GenerateGLSL() {
        Binary::GenerateGLSL();
        return "mod(" + children[0]->GenerateGLSL() + ", " +
               children[1]->GenerateGLSL() + ")";
    }
};
class Dot : public Binary {
    ...
    std::string GenerateGLSL() {
        Binary::GenerateGLSL();
        return "vec3(dot(" + children[0]->GenerateGLSL() + ", " +
               children[1]->GenerateGLSL() + "))";
    }
};
class Cross : public Binary {
    ...
    std::string GenerateGLSL() {
        Binary::GenerateGLSL();
        return "cross(" + children[0]->GenerateGLSL() + ", " +
               children[1]->GenerateGLSL() + ")";
    }
};
...
class Direction : public Binary {
    ...
    std::string GenerateGLSL() {
        Binary::GenerateGLSL();
        return "normalize(" + children[1]->GenerateGLSL() + " - " +
               children[0]->GenerateGLSL() + ")";
    }
};
...
class Step : public Binary {
    ...
    std::string GenerateGLSL() {
        Binary::GenerateGLSL();
        return "step(" + children[0]->GenerateGLSL() + ", " +
               children[1]->GenerateGLSL() + ")";
    }
};
class NGon : public Binary {
    ...
    std::string GenerateGLSL() {
        Binary::GenerateGLSL();
        // Credit https://thebookofshaders.com/07/ for the code to make regular
        // polygons using polar functions
        std::string st =
            "((" + children[0]->GenerateGLSL() /*UV*/ + " * 2.0 - 1.0).xy)";
        std::string a = "(atan(" + st + ".x, " + st + ".y) + PI)";
        std::string r = "(TWO_PI/" + children[1]->GenerateGLSL() /*N*/ + ")";
        return "vec3(cos(floor(.5+" + a + "/" + r + ")*" + r + "-" + a +
               ")*length(" + st + "))";
    }
};
...
class Combine : public Trinary {
    ...
    std::string GenerateGLSL() {
        ...
        return "vec3(" + children[0]->GenerateGLSL() + ".x, " +
               children[1]->GenerateGLSL() + ".y, " +
               children[2]->GenerateGLSL() + ".z)";
    }
};
class Clamp : public Trinary {
    ...
    std::string GenerateGLSL() {
        Trinary::GenerateGLSL();
        return "clamp(" + children[0]->GenerateGLSL() + ", " +
               children[1]->GenerateGLSL() + ", " +
               children[2]->GenerateGLSL() + ")";
    }
};
class Mix : public Trinary {
    ...
    std::string GenerateGLSL() {
        Trinary::GenerateGLSL();
        return "mix(" + children[0]->GenerateGLSL() + ", " +
               children[1]->GenerateGLSL() + ", " +
               children[2]->GenerateGLSL() + ")";
    }
};
class SmoothStep : public Trinary {
    ...
    std::string GenerateGLSL() {
        Trinary::GenerateGLSL();
        return "smoothstep(" + children[0]->GenerateGLSL() + ", " +
               children[1]->GenerateGLSL() + ", " +
               children[2]->GenerateGLSL() + ")";
    }
};
